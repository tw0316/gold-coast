...
This doc covers the production GHL batch refresh run-status path contract and the Athena smoke checks operators run after deploy or after a manual production refresh.
