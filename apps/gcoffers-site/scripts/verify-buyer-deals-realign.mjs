...
assert(map.includes('const mappedDeals = deals'), 'BuyerDealsMap must use the non-null buyer view-model map locations directly without misleading filtering aliases.')
